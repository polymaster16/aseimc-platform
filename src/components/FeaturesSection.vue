<template>
    ...
    <!-- Services Start -->
    <div class="container-fluid pt-6 px-5 mt-4 mb-8">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 mb-0 text-3xl">Qui Sommes Nous?</h1>
            <hr class="w-25 mx-auto bg-primary">
        </div>
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary1 text-center px-5">
                    <div class="d-flex align-items-center justify-content-center bg-primary1 text-white rounded-circle mx-auto mb-4" style="width: 90px; height: 90px;">
                        <svg-icon :fa-icon="faCoffee" :size="40" flip="horizontal"></svg-icon>
                    </div>
